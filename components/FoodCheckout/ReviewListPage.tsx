...
export const ReviewListPage = () => {
    ...
    useEffect(() => {
        const fetchBookReviewsData = async () => {
            ...
            const reviewUrl: string = `http://localhost:8080/api/reviews/search/findByFoodId?foodId=${foodId}&page=${currentPage - 1}&size=${reviewsPerPage}`;
            ...
            for (const key in responseData) {
                loadedReviews.push({
                    ...
                    food_id: responseData[key].food_id,
